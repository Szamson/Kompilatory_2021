        buf.write("\2\2\2TN\3\2\2\2TS\3\2\2\2U^\3\2\2\2VW\f\5\2\2WX\7\22")
        buf.write("\2\2X]\5\20\t\6YZ\f\4\2\2Z[\7\21\2\2[]\5\20\t\5\\V\3\2")
        buf.write("\2\2\\Y\3\2\2\2]`\3\2\2\2^\\\3\2\2\2^_\3\2\2\2_\21\3\2")
        buf.write("\2\2`^\3\2\2\2ab\b\n\1\2bc\7\f\2\2cf\5\24\13\2df\5\24")
        buf.write("\13\2ea\3\2\2\2ed\3\2\2\2fo\3\2\2\2gh\f\4\2\2hi\7\22\2")
        buf.write("\2in\5\22\n\5jk\f\3\2\2kl\7\21\2\2ln\5\22\n\4mg\3\2\2")
        buf.write("\2mj\3\2\2\2nq\3\2\2\2om\3\2\2\2op\3\2\2\2p\23\3\2\2\2")
        buf.write("qo\3\2\2\2rs\t\2\2\2s\25\3\2\2\2tz\7\23\2\2uv\7\24\2\2")
        buf.write("vz\5\30\r\2wz\7\25\2\2xz\7\26\2\2yt\3\2\2\2yu\3\2\2\2")
        buf.write("yw\3\2\2\2yx\3\2\2\2z\27\3\2\2\2{|\t\3\2\2|\31\3\2\2\2")
        buf.write("}~\7\31\2\2~\177\7\36\2\2\177\u0080\7\5\2\2\u0080\u0081")
        buf.write("\5\2\2\2\u0081\u0082\7\6\2\2\u0082\33\3\2\2\2\13\37(T")
        buf.write("\\^emoy")
        return buf.getvalue()
...
class GrammarParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'<'", "'>'", "'('", "')'", "'['", "']'", 
                     "<INVALID>", "'if'", "'while'", "'NO'", "'WALL'", "'ENEMY'", 
                     "'TREASURE'", "'TRAP'", "'AND'", "'OR'", "'forward'", 
                     "'turn'", "'attack'", "'disarm'", "'left'", "'right'", 
                     "'fun'", "'TRUE'", "'FALSE'", "'FOR'", "'PRINT'" ]

    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "COMMENT", 
                      "IF", "WHILE", "NEGATION", "WALL", "ENEMY", "TREASURE", 
                      "TRAP", "AND", "OR", "FORWARD", "TURN", "ATTACK", 
                      "DISARM", "LEFT", "RIGHT", "FUN", "TRUE", "FALSE", 
                      "FOR", "PRINT", "NAME", "NUMBER", "SOME_STRING", "WHITESPACE", 
                      "NEWLINE" ]
    ...
    ruleNames =  [ "statements", "statement", "function_call", "if_statement", 
                   ...
                   "bracket_cond", "cond_help", "condition", "action", "direction", 
                   "function" ]
    ...
    def statements(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GrammarParser.IF) | (1 << GrammarParser.WHILE) | (1 << GrammarParser.FORWARD) | (1 << GrammarParser.TURN) | (1 << GrammarParser.ATTACK) | (1 << GrammarParser.DISARM) | (1 << GrammarParser.FUN) | (1 << GrammarParser.FOR) | (1 << GrammarParser.PRINT) | (1 << GrammarParser.NAME))) != 0)):
                    break
    ...
    def statement(self):
        ...
        try:
            ...
            if token in [GrammarParser.IF]:
                ...
                self.for_statement()
                pass
            elif token in [GrammarParser.PRINT]:
    ...
    class If_statementContext(ParserRuleContext):
        ...
        def bracket_cond(self):
            return self.getTypedRuleContext(GrammarParser.Bracket_condContext,0)
    ...
    class Print_statementContext(ParserRuleContext):
        ...
        def SOME_STRING(self):
            return self.getToken(GrammarParser.SOME_STRING, 0)
    ...
    def print_statement(self):
        ...
        try:
            ...
            self.match(GrammarParser.T__0)
            self.state = 68
            self.match(GrammarParser.SOME_STRING)
            self.state = 69
            self.match(GrammarParser.T__1)
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Bracket_condContext(ParserRuleContext):

        def __init__(self, parser, parent:ParserRuleContext=None, invokingState:int=-1):
            super().__init__(parent, invokingState)
            self.parser = parser

        def bracket_cond(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GrammarParser.Bracket_condContext)
            else:
                return self.getTypedRuleContext(GrammarParser.Bracket_condContext,i)
        ...
        def getRuleIndex(self):
            return GrammarParser.RULE_bracket_cond

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterBracket_cond" ):
                listener.enterBracket_cond(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitBracket_cond" ):
                listener.exitBracket_cond(self)



    def bracket_cond(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = GrammarParser.Bracket_condContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 14
        self.enterRecursionRule(localctx, 14, self.RULE_bracket_cond, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 82
            self._errHandler.sync(self)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = GrammarParser.Bracket_condContext(self, _parentctx, _parentState)
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_bracket_cond)
                        self.state = 84
    ...
    def cond_help(self, _p:int=0):
        ...
        _prevctx = localctx
        _startState = 16
        self.enterRecursionRule(localctx, 16, self.RULE_cond_help, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 99
            self._errHandler.sync(self)
            ...
            if token in [GrammarParser.NEGATION]:
                ...
                self.condition()
                pass
            elif token in [GrammarParser.WALL, GrammarParser.ENEMY, GrammarParser.TREASURE, GrammarParser.TRAP, GrammarParser.TRUE, GrammarParser.FALSE]:
                self.state = 98
                self.condition()
                pass
            else:
    ...
    def condition(self):
        ...
        try:
            ...
            self.state = 112
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GrammarParser.WALL) | (1 << GrammarParser.ENEMY) | (1 << GrammarParser.TREASURE) | (1 << GrammarParser.TRAP) | (1 << GrammarParser.TRUE) | (1 << GrammarParser.FALSE))) != 0)):
    ...
    def sempred(self, localctx:RuleContext, ruleIndex:int, predIndex:int):
        ...
        self._predicates[7] = self.bracket_cond_sempred
        self._predicates[8] = self.cond_help_sempred
    ...
    def bracket_cond_sempred(self, localctx:Bracket_condContext, predIndex:int):
            if predIndex == 0:
